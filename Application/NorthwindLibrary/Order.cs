namespace NorthwindLibrary
{
    ...
    public class Order
    {
        ...
        [XmlElement] public virtual Customer Customer { get; set; }

        [XmlElement] public virtual Employee Employee { get; set; }

        [XmlIgnore] public virtual ICollection<Order_Detail> Order_Details { get; set; }

        [XmlElement] public virtual Shipper Shipper { get; set; }
    }
}
